...
public class JFinalModelGenerator {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "me.belucky.toolscenter.model.table.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/me/belucky/toolscenter/model/table/base";
		
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "me.belucky.toolscenter.model.table";
